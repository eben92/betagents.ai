...
export default defineTool({
  description:
    "Add lines to one of your notebook files, creating it if it does not exist. Use this for anything cumulative — covered.md, a per-match note — instead of write_file, which refuses to overwrite a file you have not read this session.",
